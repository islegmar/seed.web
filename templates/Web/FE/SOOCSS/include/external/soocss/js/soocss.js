...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
        	this.searcher = this.container.find('.select2-choices');
        	if (!this.searcher.length > 0) {
	        	this.searcher = this.container;
        	}
            var $dropdown = this.dropdown,
                offset = this.searcher.offset(),
                height = this.searcher.outerHeight(false),
                width = this.searcher.outerWidth(false),
            ...
            if (above) {
                ...
                if (this.showSearchInput) {
                	$dropdown.find('.select2-search').insertAfter($dropdown.children().last());
                	css.top = offset.top - dropHeight + height;
                }
            }
            else {
                css.top = dropTop;
                ...
                if (this.showSearchInput) {
                	$dropdown.find('.select2-search').insertBefore($dropdown.children().first());
                }
            }
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <span class='select2-chosen'>&#160;</span><abbr class='select2-search-choice-close ci ci-close-circled'></abbr>",
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   </ul>",
                "</div>",
                "<div class='select2-selected'></div>",
                "<ul class='custom-select2-choices'>",
                "</ul>"].join(""));
        ...
        initContainer: function () {
            ...
            this.numSelected = this.container.find(".select2-selected");
            this.selectedList = this.container.find(".custom-select2-choices");
            ...
            this.numSelected.html(this.selectedList.children().length + ' ' + this.select.attr('num-selected'));
        },
        ...
        addSelectedChoice: function (data) {
            var enableChoice = !data.locked,
                enabledItem = $(
                    ...
                    "    <div></div>" +
                    "    <a href='#' class='select2-search-choice-close ci ci-close-circled' tabindex='-1'></a>" +
                    "</li>"),
                disabledItem = $(
            ...
            choice.prependTo(this.selectedList);
            this.numSelected.html(this.selectedList.children().length + ' ' + this.select.attr('num-selected'));
...
/* SELECT 2 - TRANSFORM ALL SELECTS  */
$(".select2").select2({showSearchBox: false});
